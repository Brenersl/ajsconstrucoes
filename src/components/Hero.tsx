        ...
        <div className="max-w-3xl">
          ...
          >
            <a
              ...
              className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-accent text-accent-foreground font-heading font-bold text-base rounded hover:brightness-110 transition-all shadow-lg hover:shadow-xl uppercase tracking-wide"
            >
